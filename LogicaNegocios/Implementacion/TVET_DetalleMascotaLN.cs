...
{
    public class TVET_DetalleMascotaLN : ITVET_DetalleMascotaAD
    {
        private VETEntidades _vETEntidades;

        public TVET_DetalleMascotaLN(VETEntidades vETEntidades)
        {
        ...
        public bool agregarDetalleMascota_ENT(TVET_DetalleMascota pDetalle)
        {
            ...
            try
            {
                ...
                {
                    TVET_DetalleMascota tVET_DetallesMascota = _vETEntidades.TVET_DetalleMascota.Add(pDetalle);
